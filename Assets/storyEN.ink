...
Narrator: Once upon a time there was a man so attached to his job that he forgot the most important thing about Christmas. In his mind, the most important thing was his son's gift and the turkey his wife kept asking for.#background #0-Office
...
=== Seguir_la_carretera ===
Narrator: Continuas la carretera en dirección a la ciudad.Según avanzas ves una tenue luz entre los arboles que termina siendo de una cabaña. #background #3-ForestCabin
...
Narrator: Cuando John se dirige hacia la habitación del telefono, ve en el arbol de navidad un regalo en el que hay una etiqueta que pone "Little Timmy".#background #5-ForestCabinInterior2
...
{HideCharacter("John")}
Narrator: John deja tras de si la cabaña y continua el camino de la carretera.#background #black
...
{ShowCharacter("Lumberjack", "Right", "Fine")}Narrator: Mientras John se distancia de la cabaña a toda prisa, ve la silueta del leñador apostado en la puerta de la cabaña viendo como huyes del lugar.#background #3-ForestCabin
{HideCharacter("John")}
Narrator: John se ha dejado la chaqueta con su cartera con las prisas.#background #black
{HideCharacter("Lumberjack")}
->Direccion_Granja
=Direccion_Granja
Narrator: La tormenta ha amainado, y tras un largo camino por la carretera ves el cartel de la granja que te comentó el leñador. #background #6-TurkeyFarmSign
...
{ShowCharacter("John", "Left", "Fine")}
Narrator: John entra a la granja y ve a un señor apoyado en una valla mirando hacia un pavo y se acerca a él.{IsTalking("John","Fine")}{IsNotTalking("Farmer","Fine")}#background #7-TurkeyFarm
...
Granjero: Espera un momento, dejame preguntarle a mi hermano a ver si con suerte él tiene algún pavo de sobra.{IsTalking("Farmer","Fine")}{IsNotTalking("John","Fine")}
...
Granjero: No se preocupe, es Navidad, ya lo pagará en otra ocasión.{IsTalking("Farmer","Fine")}{IsNotTalking("John","Fine")}
...
===Vuelta_a_Casa===
Narrator: John se fija en el reloj y se da cuenta de que ya se hace tarde y debería buscar una manera mas rapida de volver a casa así que decide hacer Autostop.#background #black
Narrator: Casualmente, un camión pasa por alli y decide parar a recogerte.
John: Buenas Señor ,me dirigía hacia el pueblo que está aqui al lado {ShowCharacter("John", "Right", "Fine")}#background #8-Truck
John: ¿Le viene bien?
Camionero: Si, sin problema , montese que llegamos en un santiamen.{ShowCharacter("Trucker", "Left", "Fine")}{IsNotTalking("John","Fine")}
Narrator: John se monta en el camión y disfruta de la emisora de radio favorita del camionero, Rock FM.{HideCharacter("John")}{HideCharacter("Trucker")}#background #black
Narrator: No solo eso sino que además se atrevió a cantar a duo una de Estopa con el camionero.
->Llegada_a_casa
=== Llegada_a_casa==
Narrator: El conductor te deja en la puerta de tu casa.John ve que hay dos coches aparcados que no le suenan de nada.#background #9-JohnHouse
...
--> END
===Final_GOOD_GOOD===
Narrador: John se sienta en la mesa junto a su familia y a sus nuevos amigos.#background #11-End
...
-> Despedida
===Final_GOOD_BAD===
Narrador: Aunque John no habia sucumbido al robo del regalo, el haber robado ese pavo no le había hecho ninguna gracia a su esposa.{ShowCharacter("John","Center","Fine")}{ShowCharacter("Wife","Right","Fine")}{ShowCharacter("Son","Left","Fine")}#background #11-End
...
===Final_BAD_GOOD===
Narrador: John no debía haber tocado ese regalo. A partir de ese momento , su hijo ya no le veía con los mismos ojos.{ShowCharacter("John","Center","Fine")}{ShowCharacter("Wife","Right","Fine")}{ShowCharacter("Son","Left","Fine")}#background #11-End
...
===Final_BAD_BAD===
Narrador: Pero en que estabas pensando.{ShowCharacter("John","Center","Fine")}#background #11-End
...
=== Despedida ===
Narrator: Espero que hayas disfrutado de esta historia.#background #black
*{frozen} -> frozenEnd
