...
=== Bungalow_Familia ===
{ShowCharacter("John", "Left", "Fine")}
Narrator: You knock on the door and a lumberjack-looking man opens it.
...
I was looking for a turkey for dinner tonight.I've been busy at work and I forgot to buy it, if my wife sees me coming back without the turkey, she'll carve me.
{IsTalking("Lumberjack","Fine")}{IsNotTalking("John","Fine")}
...
John: If borrow the gift from the Christmas tree, I won't have to buy anything for my son.#thought
...
=LlamarGrua
{ShowCharacter("Phone", "Center", "Fine")}Narrator: You call the tow truck and wait for an answer.
Phone:.
Phone:..
Phone:...
Phone:....
...
->Direccion_Granja
=Direccion_Granja
Narrator: The storm has passed, and after a long walk along the road you see the sign for the farm that the lumberjack told you about. #background #6-TurkeyFarmSign
...
Farmer: Ese pavo de ahí es Linda, es la mascota más querida de esta familia y por nada del mundo la pondría a la venta y mucho menos si es para comersela.
That turkey over there is Linda, she is the most beloved pet of this family and for nothing in this world would I put her on sale, even less if it is to be eaten.{IsTalking("Farmer","Fine")}{IsNotTalking("John","Fine")}
...
John: This would be a good time to steal that turkey. # thought
...
->Vuelta_a_Casa
=EsperarGranjero
Narrator: John waits for the Farmer leaning on the fence just as he was a few minutes ago.
...
===Vuelta_a_Casa===
Narrator: John looks at the clock and realizes that it's getting late and he should find a quicker way home so he decides to hitchhike.#background #black
...
Trucker: Yes, no problem, we'll be there in a jiffy.{ShowCharacter("Trucker", "Left", "Fine")}{IsNotTalking("John","Fine")}
...
->Llegada_a_casa
=== Llegada_a_casa==
Narrator: The driver drops you off at your door. John sees two parked cars that do not look familiar to him.#background #9-JohnHouse
...
Narrator: As you approach the lumberjack, he can see that you are carrying Timmy's gift under your arm.
...
Narrator:You approach the Lumberjack and his family and see how his son is holding the gift you saw on the Christmas tree in the cabin.
...
Narrator: As you approach the farmerhe can see that you are carrying the beloved Linda under your arm. 
...
Farmer's Brother: Good night John, my brother told me that you needed a turkey, so here I am.{IsTalking("FarmerBrother","Fine")}{IsNotTalking("John","Fine")}
...
--> END
===Final_GOOD_GOOD===
Narrador: John sits at the table with his family and new friends.#background #11-End
...
-> Despedida
===Final_GOOD_BAD===
Narrador: Even though John had not surrendered to steal the gift, stealing that turkey didn't seem right to his wife.{ShowCharacter("John","Center","Fine")}{ShowCharacter("Wife","Right","Fine")}{ShowCharacter("Son","Left","Fine")}#background #11-End
...
===Final_BAD_GOOD===
Narrador: John shouldn't have touched that gift. From that moment on, his son no longer looked at him with the same eyes.{ShowCharacter("John","Center","Fine")}{ShowCharacter("Wife","Right","Fine")}{ShowCharacter("Son","Left","Fine")}#background #11-End
...
===Final_BAD_BAD===
Narrador: What were you thinking?{ShowCharacter("John","Center","Fine")}#background #11-End
...
=== Despedida ===
Narrator: I hope you enjoyed this story.#background #black
*{frozen} -> frozenEnd
