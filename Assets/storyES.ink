...
Narrator: Érase una vez un hombre tan apegado a su trabajo que olvidó lo más importante de la navidad. A su parecer, lo más importante era el regalo de su hijo y el pavo que no paraba de pedirle su mujer.#background #0-Office
Narrator: Así es como decidió cuando anochecía montarse en su coche y ponerse en marcha.#background #1-carinterior
Narrator: Lo que él no esperaba es que una tormenta de nieve lo aplacaría, haciéndole resbalar chocando contra un árbol y dejando su coche varado en la cuneta. #sound #scream
{HideCharacter("John")}
-> escena_carretera
...
=LlamarGrua
{ShowCharacter("Phone", "Center", "Fine")}Narrator: Llamas a la grúa y esperas a que te contesten.
Phone:.
Phone:..
Phone:...
Phone:....
...
John: Buenas señor, se que es tarde, espero no molestarle, venía a preguntarle si aún le quedaba algún pavo a la venta.{IsTalking("John","Fine")}{IsNotTalking("Farmer","Fine")}#background #7-TurkeyFarm
...
===Vuelta_a_Casa===
Narrator: John se fija en el reloj y se da cuenta de que ya se hace tarde y debería buscar una manera más rápida de volver a casa así que decide hacer Autostop. #background #black
...
Narrator: Según te acercas al leñador, él puede ver como tienes el regalo de Timmy bajo el brazo.
...
Narrator:Te acercas al leñador y a su familia y ves como su hijo tiene en sus manos el regalo que viste en el árbol de navidad de la cabaña.
...
Hermano Granjero: Buenas John, mi hermano me contó lo que te pasaba así que aquí estoy.{IsTalking("FarmerBrother","Fine")}{IsNotTalking("John","Fine")}
...
===Final_BAD_GOOD===
Narrador: John no debería haber tocado ese regalo. A partir de ese momento , su hijo ya no le veía con los mismos ojos.{ShowCharacter("John","Center","Fine")}{ShowCharacter("Wife","Right","Fine")}{ShowCharacter("Son","Left","Fine")}#background #11-End
...
===Final_BAD_BAD===
Narrador: Pero en qué estabas pensando.{ShowCharacter("John","Center","Fine")}#background #11-End
